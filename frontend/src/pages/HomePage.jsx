        ...
        <div className="hero-content flex-col lg:flex-row-reverse gap-10 py-10">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl lg:text-5xl font-bold leading-tight">
              <span className="text-primary">R-FACT LLC</span> Vehicle Management
            </h1>
            <p className="py-4 text-base-content/60">
              Manage vehicle repair records, paint jobs, and service details quickly and efficiently.
            </p>
        ...
        {products.length === 0 ? (
          <div className="card bg-base-300">
            <div className="card-body items-center text-center py-16">
              ...
              <h3 className="card-title text-base-content/50">No vehicles yet</h3>
